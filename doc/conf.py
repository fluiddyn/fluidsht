...
project = 'FluidSHT'
copyright = '2019, FluidDyn Developers'
...
latex_documents = [
    (master_doc, 'FluidSHT.tex', 'FluidSHT Documentation',
     'FluidDyn Developers', 'manual'),
]
...
man_pages = [
    (master_doc, 'fluidsht', 'FluidSHT Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'FluidSHT', 'FluidSHT Documentation',
     author, 'FluidSHT', 'One line description of project.',
     'Miscellaneous'),
]
